## 目录
- [1. 解释一下GBDT算法的过程](##1-解释一下gbdt算法的过程)
  - [1.1 Boosting思想](##11-boosting思想)
  - [1.2 GBDT原来是这么回事](##12-gbdt原来是这么回事)
- [2. 梯度提升和梯度下降的区别和联系是什么？](##2-梯度提升和梯度下降的区别和联系是什么)
- [3. GBDT的优点和局限性有哪些？](##3-gbdt的优点和局限性有哪些)
  - [3.1 优点](##31-优点)
  - [3.2 局限性](##32-局限性)
- [4. RF(随机森林)与GBDT之间的区别与联系](##4-rf随机森林与gbdt之间的区别与联系)
- [5. 代码实现](#/GBDT_demo.ipynb)
