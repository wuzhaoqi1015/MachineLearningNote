## 目录
- [1. 什么是XGBoost](#1-什么是xgboost)
  - [1.1 XGBoost树的定义](#11-xgboost树的定义)
  - [1.2 正则项：树的复杂度](#12-正则项树的复杂度)
  - [1.3 树该怎么长](#13-树该怎么长)
  - [1.4 如何停止树的循环生成](#14-如何停止树的循环生成)
- [2. XGBoost与GBDT有什么不同](#2-xgboost与gbdt有什么不同)
- [3. 为什么XGBoost要用泰勒展开，优势在哪里？](#3-为什么xgboost要用泰勒展开优势在哪里)
- [4. 代码实现](https://github.com/wuzhaoqi1015/MachineLearningNote/tree/main/MachineLearningBase/6_XGBoost/3.3%20XGBoost.ipynb)
- [5. 参考文献](#5-参考文献)
